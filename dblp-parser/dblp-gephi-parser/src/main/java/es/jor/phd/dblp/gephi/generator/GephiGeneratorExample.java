...
public class GephiGeneratorExample {

	public static void main(String[] args) {
		Gexf gexf = new GexfImpl();
		Calendar date = Calendar.getInstance();

		gexf.getMetadata().setLastModified(date.getTime()).setCreator("Myself").setDescription("A Web network");
		...
		gephi.setLabel("Gephi").setSize(20).getAttributeValues().addValue(attUrl, "http://gephi.org")
		...
		webatlas.setLabel("Webatlas").getAttributeValues().addValue(attUrl, "http://webatlas.fr").addValue(attIndegree,
				"2");
		...
		blab.setLabel("BarabasiLab").getAttributeValues().addValue(attUrl, "http://barabasilab.com")
