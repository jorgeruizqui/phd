 ...
 */
@Slf4j
public class PacmanAIFixedRadius implements IGameObjectAI {
    ...
    public void applyAIonObject(GameContext gameContext, IGameObject player) {
        ...
        PlayerNextMoveComparatorFixedRadius playerNextMoveComparator = new PlayerNextMoveComparatorFixedRadius(gameContext, DEFAULT_RADIUS);
        List<PlayerNextMoveComparatorFixedRadius.ItemMovementSolution> solutions = playerNextMoveComparator.orderedSolutions();

        boolean moved = false;
        for (PlayerNextMoveComparatorFixedRadius.ItemMovementSolution solution : solutions) {
